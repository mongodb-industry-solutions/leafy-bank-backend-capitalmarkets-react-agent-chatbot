...
The Market Assistant Agent serves as a sophisticated financial advisor leveraging multiple specialized tools to provide comprehensive portfolio insights and market intelligence. Here's how the agent operates:

1. Query Understanding: The agent first analyzes the user's financial question, determining which specialized tool is most appropriate for retrieving the needed information.

### Agent Tools

The Market Assistant ReAct Agent leverages a suite of specialized tools that enable it to access and analyze financial data from various sources. These tools are carefully designed to provide comprehensive market intelligence while maintaining clear boundaries between portfolio-specific analysis and general financial information.

#### Portfolio-Specific Tools

1. **Market Analysis Reports Vector Search Tool**  
   - **Purpose**: Retrieves relevant market insights specifically for assets in the current portfolio.  
   - **Data Source**: `reports_market_analysis` collection with vector embeddings generated by the [voyage-finance-2](https://blog.voyageai.com/2024/06/03/domain-specific-embeddings-finance-edition-voyage-finance-2/) model.  
   - **Key Features**:  
...
2. **Market News Reports Vector Search Tool**  
...
- [scheduler](https://pypi.org/project/scheduler/) for agent workflow scheduling and ETL job management.
