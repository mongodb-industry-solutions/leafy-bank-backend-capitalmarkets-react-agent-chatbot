...
-  **Vector Search**: Semantic understanding of financial market data, news articles, and social media sentiment is achieved through [MongoDB Atlas Vector Search](https://www.mongodb.com/products/platform/atlas-vector-search). This allows the agent to find semantically similar results across market analysis, news, and social media reports. The vector search is performed on three collections:
